...
export default function GoogleButton({ className, ...rest }: React.ButtonHTMLAttributes<HTMLButtonElement>) {
    return (
        <Button variant="secondary" className={cn('flex w-full cursor-pointer items-center justify-center gap-2', className)} {...rest}>
            <svg width="40" height="40" viewBox="0 0 40 40" className="size-9" fill="none" xmlns="http://www.w3.org/2000/svg">
